...
def init_sample_data():
    ...
    # 创建示例学生
    students = [
        Student(student_id='2023001', name='张三', class_name='计算机1班', email='zhangsan@example.com'),
        Student(student_id='2023002', name='李四', class_name='计算机1班', email='lisi@example.com'),
        Student(student_id='2023003', name='王五', class_name='计算机2班', email='wangwu@example.com'),
        Student(student_id='2023004', name='赵六', class_name='计算机2班', email='zhaoliu@example.com')
    ]
