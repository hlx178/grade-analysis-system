...
def create_app(config_name="default"):
    ...
    # 注册蓝图
    from app.routes import api_bp, auth_bp, health_bp, main_bp
    ...
    def _handle_exception(e):
        try:
            ...
            if getattr(request, "path", "").startswith("/api/"):
                return (
                    jsonify(
                        {"error": "internal_error", "type": type(e).__name__, "message": str(e)}
                    ),
                    500,
                )
        except Exception:
        ...
        def inject_brand():
            ...
            try:
                ...
                def _default_modules(role: str):
                    ...
                    if role == "teacher":
                        return set(
                            ["students", "courses", "grades", "summary", "import", "my_scores"]
                        )
                    if role == "student":
                        return set(["my_scores", "student_analysis"])
                    return set()
        ...
        def inject_brand():
            ...
            try:
                ...
                def _default_modules(role: str):
                    ...
                    if role == "student":
                        return set(["students", "grades", "summary"])
                    return set()
